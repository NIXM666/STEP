    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch(type)
        {
            case TYPE_1:
                ...
                Bitmap drawable1 = imageLoader.loadDrawable(msynamic.getUserHeadPicture(), new AsyncImageLoader.ImageCallback() {
                    @Override
                ...
                if (drawable1 == null) {
                    ...
                    viewHoldItem.img_head.setImageBitmap(drawable1);
                }
                Bitmap drawable = imageLoader.loadDrawable(msynamic.getPicture(), new AsyncImageLoader.ImageCallback() {
                    @Override
                    public void imageLoaded(Bitmap imageDrawable, String imageUrl) {
                        ImageView imageViewByTag = (ImageView) listview.findViewWithTag(imageUrl);
                        if (imageViewByTag != null) {
                ...
                if (drawable == null) {
                    ...
                    viewHoldItem.img_bg.setImageBitmap(drawable);
                }
            ...
            case TYPE_2:
                ...
                Bitmap drawable3 = imageLoader.loadDrawable(mylist.get(i-1).getObserverHeadPicture(), new AsyncImageLoader.ImageCallback() {
                    @Override
                    public void imageLoaded(Bitmap imageDrawable, String imageUrl) {
                        ImageView imageViewByTag = (ImageView) listview.findViewWithTag(imageUrl);
                        if (imageViewByTag != null) {
                ...
                if (drawable3 == null) {
                    ...
                    viewHold.commentHead.setImageBitmap(drawable3);
                }
