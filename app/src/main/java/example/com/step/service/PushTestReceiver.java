...
public class PushTestReceiver extends PushMessageReceiver {
   ...
   // private MesageSQliteUtil msgSqlUtil;
    private static  Context context;
    private static NewsEntity newsEntity=new NewsEntity();
    private static MessageBean messageBean=new MessageBean();
    private static String channelId;

    private final static String PUSH_ACTIVITY = "activities";

    private final static String PUSH_SOS = "sos";

    private final static String PUSH_LOCATION = "location";
    ...
    public void onNotificationArrived(Context context, String s, String s1, String s2) {
        ...
        String notifyString = "onNotificationArrived  title=\"" + s
                + "\" description=\"" + s1 + "\" customContent="
                + s2;
        Log.d("xyz", "onNotificationArrived=" + notifyString);
        if(!s2.isEmpty())
        {
            ...
            //msgSqlUtil=new MesageSQliteUtil(context);
            //msgSqlUtil.createTable();
           // msgSqlUtil.insert(messageBean);
        }
